...
export interface ApiPortfolioPortfolio extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    experience: Schema.Attribute.Component<'portfolio.experience', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    projects: Schema.Attribute.DynamicZone<['portfolio.project']>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'portfolio.seo', false>;
